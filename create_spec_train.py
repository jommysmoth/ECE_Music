...
def clipping_song(song, seconds_clip):
    ...
    rand_end = rand_start + 50000  # Changed!!
...
def main():
    ...
    labels = ['Experimental Rock', 'Grindcore',
              'Hardcore', 'Indie Rock', 'Post Rock']  # Made by hand, since honestly not many labels
    seconds_clip = 3
    data_dict = add_label(labels,
                          seconds_clip)  # Label Dictionary:Set Amount Per Label-Data_X-Data_Y-Channels
